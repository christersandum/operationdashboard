...
export const INCIDENTS_SWORD_STAGED = [
  {
    ...
    priority: 'medium', lat: 59.907, lng: 10.762, timestamp: 15,
    assignAll: false, colorIndex: 0,
    chatMessages: [
      { sender: 'Operasjonssentral', initials: 'OS', color: '#e74c3c', timestamp: 16,
        text: '🔥 Bil i brann meldt ved Grønland T-banestasjon. Enheter utsendt.' },
    ],
    arrivalMessages: [
      { sender: 'System', initials: '⚙', color: '#6b7280', system: true, timestamp: 18,
  ...
  },
  {
    ...
    priority: 'low', lat: 59.926, lng: 10.715, timestamp: 45,
    assignAll: false, colorIndex: 1,
    chatMessages: [
      { sender: 'Operasjonssentral', initials: 'OS', color: '#f39c12', timestamp: 46,
        text: '🚛 Kjøretøy sperrer E18 ved Majorstua. Enheter disponert.' },
    ],
    arrivalMessages: [
      { sender: 'System', initials: '⚙', color: '#6b7280', system: true, timestamp: 48,
  ...
  },
  {
    ...
    priority: 'high', lat: 59.891, lng: 10.816, timestamp: 75,
    assignAll: false, colorIndex: 2,
    chatMessages: [
      { sender: 'Operasjonssentral', initials: 'OS', color: '#9b59b6', timestamp: 76,
        text: '💥 Eksplosjon ved Bryn bensinstasjon. Beredskapstropp sendes umiddelbart!' },
      { sender: 'Delta-1', initials: 'D1', color: '#e74c3c', timestamp: 78,
        text: 'Delta rykker ut til Bryn. ETA 4 minutter. Sikrer perimeter.' },
    ],
    arrivalMessages: [
      { sender: 'Delta-1', initials: 'D1', color: '#e74c3c', timestamp: 80,
  ...
  },
  {
    ...
    priority: 'medium', lat: 59.925, lng: 10.765, timestamp: 105,
    assignAll: false, colorIndex: 3,
    chatMessages: [
      { sender: 'Operasjonssentral', initials: 'OS', color: '#1abc9c', timestamp: 106,
        text: '🚨 Overfall meldt ved Skøyen. Enheter på vei til stedet.' },
      { sender: 'Lege-1', initials: 'L1', color: '#2ecc71', timestamp: 108,
        text: 'Medisinsk enhet tar seg av skadeofferet. Tilstand vurderes.' },
    ],
    arrivalMessages: [
      { sender: 'System', initials: '⚙', color: '#6b7280', system: true, timestamp: 110,
  ...
  },
  {
    ...
    priority: 'alarm', lat: 59.913, lng: 10.741, timestamp: 140,
    assignAll: true, colorIndex: 0,
    chatMessages: [
      { sender: 'System', initials: '⚙', color: '#e74c3c', system: true, timestamp: 141,
        text: '🚨🏦 BANKRØVERI PÅGÅR — Storgata Bank — ALLE ENHETER RYK UT NÅ!' },
      { sender: 'PolitiInsp. Hansen', initials: 'KH', color: '#0078d4', timestamp: 142,
        text: 'ALLE ENHETER TIL STORGATA BANK UMIDDELBART. Bevæpnede ranere inne i banken.' },
      { sender: 'Kommando-1', initials: 'K1', color: '#f39c12', timestamp: 144,
        text: 'Kommandopost er orientert. Koordinerer med DELTA og TAKTISK. SWAT-team varslet.' },
      { sender: 'Delta-1', initials: 'D1', color: '#e74c3c', timestamp: 146,
        text: 'Delta rykker ut til Storgata. 3 minutter ETA. Avventer ordre om aksjon.' },
      { sender: 'Patrulje-1', initials: 'P1', color: '#0078d4', timestamp: 148,
        text: 'P1 sperrer nordlig utgang. Evakuerer sivile i omegn.' },
      { sender: 'Patrulje-2', initials: 'P2', color: '#0078d4', timestamp: 150,
        text: 'P2 ankommer sørfra. Gateplan sikret.' },
    ],
    arrivalMessages: [
      { sender: 'Delta-1', initials: 'D1', color: '#e74c3c', timestamp: 160,
        text: '🏦 Delta på stedet. Forhandler kontaktet. Bygget sikret utenfra.' },
      { sender: 'Taktisk-1', initials: 'T1', color: '#9b59b6', timestamp: 165,
        text: 'Taktisk team klar til inntrengning ved signal. Avventer ordre.' },
      { sender: 'PolitiInsp. Hansen', initials: 'KH', color: '#0078d4', timestamp: 170,
...
export const MISSIONS_SWORD_STAGED = [
  { id: 'OPP-001', incidentId: 'HEN-001', title: 'Slukk brannen',           desc: 'Brannslukking ved Grønland T-bane',                              status: 'active', timestamp: 20 },
  { id: 'OPP-002', incidentId: 'HEN-001', title: 'Sikre perimeter',          desc: 'Etabler sikkerhetsperimeter rundt brannstedet',                   status: 'active', timestamp: 20 },
  { id: 'OPP-003', incidentId: 'HEN-002', title: 'Fjern kjøretøy',           desc: 'Koordiner fjerning av blokkerende lastebil',                      status: 'active', timestamp: 50 },
  { id: 'OPP-004', incidentId: 'HEN-002', title: 'Trafikkregulering',        desc: 'Etabler alternativ trafikkrute ved Majorstua',                    status: 'active', timestamp: 50 },
  { id: 'OPP-005', incidentId: 'HEN-003', title: 'Søk etter skadde',         desc: 'Systematisk søk etter skadde ved eksplosjonsstedet',              status: 'active', timestamp: 80 },
  { id: 'OPP-006', incidentId: 'HEN-003', title: 'Sikre område',             desc: 'Avsperr og sikre eksplosjonsstedet ved Bryn',                     status: 'active', timestamp: 80 },
  { id: 'OPP-007', incidentId: 'HEN-004', title: 'Pågripelse',               desc: 'Identifiser og pågrip gjerningspersonene',                       status: 'active', timestamp: 110 },
  { id: 'OPP-008', incidentId: 'HEN-004', title: 'Medisinsk assistanse',     desc: 'Yte medisinsk hjelp til overfallsofferet',                        status: 'active', timestamp: 110 },
  { id: 'OPP-009', incidentId: 'HEN-005', title: 'Yte livredding',           desc: 'Sikre at ingen liv går tapt under bankranet',                     status: 'active', timestamp: 145 },
  { id: 'OPP-010', incidentId: 'HEN-005', title: 'Sikre gissler',            desc: 'Etabler kontakt med ranerne om gisslenes sikkerhet',              status: 'active', timestamp: 145 },
  { id: 'OPP-011', incidentId: 'HEN-005', title: 'Omringe banken',           desc: 'Plasser enheter rundt alle utganger av banken',                   status: 'active', timestamp: 145 },
  { id: 'OPP-012', incidentId: 'HEN-005', title: 'Forhandle med ranere',     desc: 'Forhandlingsleder etablerer kontakt med ranerne',                 status: 'active', timestamp: 145 },
  { id: 'OPP-013', incidentId: 'HEN-005', title: 'Taktisk inntrengning',     desc: 'Delta-team klargjør for taktisk inntrengning ved signal',         status: 'active', timestamp: 145 },
];

export const CHAT_SWORD = [
  { id: 1, sender: 'System',             initials: '⚙',  color: '#6b7280', system: true, self: false, time: '07:30', timestamp: 0,   text: 'Operasjon Norwegian Sword — Alle enheter meldt inn og klare.' },
  { id: 2, sender: 'PolitiInsp. Hansen', initials: 'KH', color: '#0078d4', self: false,  time: '07:31', timestamp: 5,   text: 'Alle enheter stand-by. Vi har etterretning om mulig organisert kriminalitet i Oslo-sentrum i dag.' },
  { id: 3, sender: 'Patrulje-1',         initials: 'P1', color: '#0078d4', self: false,  time: '07:35', timestamp: 10,  text: 'P1 i posisjon. Starter patruljering nord i AO.' },
  { id: 4, sender: 'Delta-1',            initials: 'D1', color: '#e74c3c', self: false,  time: '07:40', timestamp: 12,  text: 'Delta-team klart. Avventer ordre fra kommandopost.' },
  { id: 5, sender: 'Deg',                initials: 'AU', color: '#0078d4', self: true,   time: '07:45', timestamp: 20,  text: 'Bekreft — alle enheter holder radiokontakt hvert 10. minutt.' },
  { id: 6, sender: 'Kommando-1',         initials: 'K1', color: '#f39c12', self: false,  time: '07:46', timestamp: 25,  text: 'Kommandopost er operativ. Overvåker alle sektorer.' },
];
